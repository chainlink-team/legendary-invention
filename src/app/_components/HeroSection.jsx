export default function HeroSection() {
  return (
    <section id="hero" className="min-h-screen items-center flex flex-col pt-44 px-36">
      <div className="font-display flex text-white flex-col text-center items-center gap-4">
        ...
        <div className="flex gap-8">
          <div className="bg-gradient-to-r from-red-magic to-blue-magic rounded-lg p-0.5 cursor-pointer">
